    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 glass-dark backdrop-blur-xl">
      <div className="container flex h-20 items-center justify-between px-6 lg:px-8 mx-auto">
        <Link href="/" className="flex items-center space-x-3 group">
          ...
          <span className="text-2xl font-bold gradient-text text-white">
            CareerPath
          </span>
        </Link>
        ...
        <div className="flex items-center space-x-4">
          <Link href="/login">
            <button className="px-4 py-1.5 text-slate-300 hover:text-white hover:bg-white/10 rounded-xl glass-button border-0">
              Sign In
            </button>
          </Link>
          <Link href="/signup">
            <button className="glass-button bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-600 hover:to-cyan-600 text-white border-0 shadow-glow hover:shadow-glow-lg transition-all duration-300 rounded-xl px-4 py-1.5 relative overflow-hidden group">
